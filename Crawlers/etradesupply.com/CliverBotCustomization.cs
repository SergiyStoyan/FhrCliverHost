...
Developed by: www.cliversoft.com";
        ...
        new static public void SessionCreating()
        {
            ...
            Cliver.Fhr.CrawlerHost.CrawlerApi.Initialize();
        }
        ...
        public class CategoryItem : InputItem
        {
            ...
            public CategoryItem(string url)
            {
                Url = url;
            }
            ...
            override public void PROCESSOR(BotCycle bc)
            {
                ...
                DataSifter.Capture gc = cb.category2.Parse(cb.HR.HtmlResult);
                string[] urls = Spider.GetAbsoluteUrls(gc.ValuesOf("CategoryUrl"), cb.HR.ResponseUrl, cb.HR.HtmlResult);
                foreach (string url in urls)
        ...
        DataSifter.Parser category2 = new DataSifter.Parser("Category2.fltr");
