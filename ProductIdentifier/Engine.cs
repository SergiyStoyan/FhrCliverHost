...
WHERE b.LinkId IS NULL"].GetSingleValue();
        ...
        //!!!Recreate Engine if kept for reuse, after performing self-training!!!

        public void PerformSelfTraining()
        {
            Configuration.ClearBeforeSelfTraining();
